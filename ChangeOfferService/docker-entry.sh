...
jar xf change_offer_service.jar BOOT-INF/classes/application.properties
...
jar uf change_offer_service.jar BOOT-INF/classes/application.properties
cat BOOT-INF/classes/application.properties
java -jar change_offer_service.jar