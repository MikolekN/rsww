...
public class PreferencesRestController {
    ...
    @Autowired
    public PreferencesRestController(PreferencesService preferencesService) {
        this.preferencesService = preferencesService;
    }

    @GetMapping("/{username}")
    public ResponseEntity<PreferencesResponse> getPreferences(@PathVariable String username) {
