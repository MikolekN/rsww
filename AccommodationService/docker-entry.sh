...
jar xf accommodation_service.jar BOOT-INF/classes/application.properties
...
jar uf accommodation_service.jar BOOT-INF/classes/application.properties
cat BOOT-INF/classes/application.properties
java -jar accommodation_service.jar